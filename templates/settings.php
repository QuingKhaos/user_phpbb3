<form id="phpbb3" action="#" method="post">
    <fieldset class="personalblock">
        ...
        <p>
            ...
            <label for="phpbb3_db_password"><?php echo $l->t('DB Password');?></label>
            <input type="text" id="phpbb3_db_password" name="phpbb3_db_password" 
                value="<?php echo $_['phpbb3_db_password']; ?>" />
        </p>
